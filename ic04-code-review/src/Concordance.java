...
public class Concordance {
    ...
    public static List<String> readFile(String filename) throws Exception {
        ...
        //while ((line= reader.readLine()) != null) {  //not always safe but makes the code DRY
       for (line= reader.readLine(); line != null; line=reader.readLine()){   //While loop implemented as a for loop
            allLines.add(line);
